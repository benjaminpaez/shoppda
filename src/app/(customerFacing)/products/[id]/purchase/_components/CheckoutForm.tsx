...
export function CheckoutForm({ product, clientSecret }: TCheckoutForm){
    return(
...
function Form({ priceInCents, productId }: { priceInCents: number, productId: string }) {
    ...
    async function handleSumbit(e: FormEvent) {
        ...
        if (orderExists) {
            setErrorMessage("You hace already purchased this product. Try downloading it from the My Orders page")
            setIsLoading(false)
            return
        }
